...
<head>
    ...
    <meta property="og:image" content="http://yesimmo.ci/template/images/logo-blue.png" />
    ...
    <meta property="og:description" content="Residences meublée et appartement en location, immobilier - vente - appartement - location - meuble - résidence" />
    <meta name="twitter:title" content="" />
    <meta name="twitter:image" content="http://yesimmo.ci/template/images/logo-blue.png" />
...
<body>
    ...
    <header id="header" class="site-header">
					...
					<div class="row">
						<div class="col-lg-5">
							<div class="footer__top__info">
								<a title="Logo" href="" class="footer__top__info__logo"><img src="{{asset('/template/images/assets/logo.png')}}" alt="Golo"></a>
								<p class="footer__top__info__desc">L’agence immobilière repensée pour mieux vous accompagner</p>
      ...
      <!-- large modal -->
<div class="modal fade" id="confModal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true" style="border-radius: 40px;">
    ...
    $(document).ready(function () {
        ...
        $('body').on('change', '#datefin', function () {
            ...
            var cout = (Math.round(days_Diff) * jour);
             ...
             var coutSejour  = "Cout du sejour   " +new Intl.NumberFormat().format(cout) +" XOF";
             var nbreJour = "Nombre de jour " +days_Diff;
             var logement = "Logement    " +new Intl.NumberFormat().format(jour)+" XOF";

             document.getElementById("CoutSejour").value = cout;
             document.getElementById("NbreJour").value = days_Diff;

            $('.box_reservation').append(function(){

                return coutSejour+"<br>"+nbreJour+"<br>"+logement;
...
@if(Session::has('success'))
  <script>
    $( document ).ready(function() {
      ...
      setTimeout(function() { $('#confModal').modal('hide'); }, 5000);
   });
