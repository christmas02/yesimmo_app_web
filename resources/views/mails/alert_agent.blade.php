                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td align="left" valign="top"
                                                                ...
                                                                @if($data['type'] == 2)
                                                                Bonjour monsieur/ madame {{ $data['nom_agent']}} vous avez une viste prévue le {{ $data['date_debut']}} avec un client, {{ $data['nom_client']}} <br>Contact du client 
                                                                est {{ $data['phone_client']}} <br> Adresse mail  {{ $data['email_client']}}. <br><br>
                                                                @elseif($data['type'] == 1)
                                                                Bonjour monsieur/ madame {{ $data['nom_agent']}} vous avez une reservation de l'appartement meublé  {{ $data['titre']}} pour la periode du {{ $data['date_debut']}} au {{ $data['date_fin']}}  par Mr / Mm {{ $data['nom_client']}} (Client) <br>
                                                                ...
                                                                Connectez-vous a votre espace utilisateur pour avoir plus de detail sur la reseversation
                                                                <a href="yesimmo.ci/connexion"> cliquer ici</a>
