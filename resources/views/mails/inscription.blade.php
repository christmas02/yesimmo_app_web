                ...
                <tr>
                    <td align="left" valign="top" style="direction:ltr;padding:0 24px 0 24px">
                        <p style="margin:0;padding:0;color:#131313;font-family:Roboto,Arial,Helvetica,sans-serif;font-size:16px;font-weight:400;line-height:24px;letter-spacing:0.1px">
                            <h3> Bonjour {{ $notifiable->name }} </h3>
                            <p> 
                                Votre compte à bien été crée. Cependant il doit être confirmer afin que vous puissez y accéder. Merci de cliquer sur le lien suivant.
                                <a  href="{{url('confirm/'.$notifiable->id.'/'.$notifiable->confirmation_token.'')}}">Confirmer mon compte</a>
